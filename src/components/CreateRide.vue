          ...
          <v-card>
            <v-card-text>
              <v-form v-model="valid" ref="form" lazy-validation>
                <v-text-field label="Email" v-model="driver_email" :rules="driver_email_rules" required></v-text-field>
                ...
                <v-text-field label="Numéro de téléphone" v-model="driver_phone_number" :rules="driver_phone_number_rules" required></v-text-field>
