...
export default {
  ...
  mounted () {
    axios.get(process.env.API_BASE_URL + '/api/relays/').then(response => {
  ...
  methods: {
    ...
    deleteItem (item) {
      ...
      if (confirm('Are you sure you want to delete this relay?')) {
        axios
          .delete(process.env.API_BASE_URL + '/api/relays/' + item._id)
    ...
    saveItem () {
      ...
      if (this.editedIndex > -1) {
        ...
        if (this.$refs.form.validate()) {
          axios.put(process.env.API_BASE_URL + '/api/relays/' + this.editedItem._id, {
          ...
          // Insert a new item
        if (this.$refs.form.validate()) {
          axios.post(process.env.API_BASE_URL + '/api/relays/', {
            host_email: this.editedItem.host_email,
            host_last_name: this.editedItem.host_last_name,
            host_first_name: this.editedItem.host_first_name,
            number_of_guests: this.editedItem.number_of_guests,
